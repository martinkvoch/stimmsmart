    ...
    public class Procedure: MDMTable
    {
        ...
        public static void Init()
        {
            ...
            using(Procedure proc = new Procedure()) using(ProcSegment seg = new ProcSegment())
            {
                ...
                seg.Insert(id, 1, 0, 20, 76, 533);
                seg.Insert(id, 1, 1, 10, 10, 533);
                seg.Insert(id, 2, 0, 10, 109, 533);
                seg.Insert(id, 2, 1, 20, 273, 533);
                seg.Insert(id, 3, 0, 20, 76, 533);
                seg.Insert(id, 3, 1, 10, 10, 533);
                seg.Insert(id, 4, 0, 10, 109, 533);
                seg.Insert(id, 4, 1, 20, 273, 533);
                seg.Insert(id, 5, 0, 20, 76, 533);
                seg.Insert(id, 5, 1, 10, 10, 533);
                seg.Insert(id, 6, 0, 10, 109, 533);
                seg.Insert(id, 6, 1, 20, 273, 533);
