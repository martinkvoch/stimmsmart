    ...
    public class Procedure: MDMTable
    {
        ...
        public static void Init()
        {
            ...
            using(Procedure proc = new Procedure()) using(ProcSegment seg = new ProcSegment())
            {
                ...
                seg.Insert(id, 1, 0, 20, 109, 533);
                seg.Insert(id, 1, 1, 10, 273, 533);
                seg.Insert(id, 2, 0, 10, 76, 533);
                seg.Insert(id, 2, 1, 20, 10, 533);
                seg.Insert(id, 3, 0, 20, 109, 533);
                seg.Insert(id, 3, 1, 10, 273, 533);
                seg.Insert(id, 4, 0, 10, 76, 533);
                seg.Insert(id, 4, 1, 20, 10, 533);
                seg.Insert(id, 5, 0, 20, 109, 533);
                seg.Insert(id, 5, 1, 10, 273, 533);
                seg.Insert(id, 6, 0, 10, 76, 533);
                seg.Insert(id, 6, 1, 20, 10, 533);
                ...
                seg.Insert(id, 2, 1, 15, 76, 817);
                seg.Insert(id, 3, 0, 15, 109, 817);
                seg.Insert(id, 3, 1, 15, 10, 817);
                seg.Insert(id, 4, 0, 15, 273, 817);
                seg.Insert(id, 4, 1, 15, 76, 817);
                seg.Insert(id, 5, 0, 15, 109, 817);
                seg.Insert(id, 5, 1, 15, 10, 817);
                seg.Insert(id, 6, 0, 15, 273, 817);
                seg.Insert(id, 6, 1, 15, 76, 817);
                seg.Insert(id, 7, 0, 15, 109, 817);
                seg.Insert(id, 7, 1, 15, 10, 817);
                seg.Insert(id, 8, 0, 15, 109, 817);
                seg.Insert(id, 8, 1, 15, 10, 817);
                seg.Insert(id, 9, 0, 15, 109, 817);
                seg.Insert(id, 9, 1, 15, 10, 817);
                seg.Insert(id, 10, 0, 15, 109, 817);
                seg.Insert(id, 10, 1, 15, 10, 817);
                seg.Insert(id, 11, 0, 15, 273, 817);
                seg.Insert(id, 11, 1, 15, 76, 817);
                seg.Insert(id, 12, 0, 15, 273, 817);
                seg.Insert(id, 12, 1, 15, 76, 817);
                seg.Insert(id, 13, 0, 15, 109, 817);
                seg.Insert(id, 13, 1, 15, 10, 817);
                ...
                seg.Insert(id, 1, 0, 15, 174, 778);
                seg.Insert(id, 1, 1, 5, 273, 1076);
                seg.Insert(id, 1, 2, 10, 76, 500);
                seg.Insert(id, 2, 0, 15, 174, 752);
                seg.Insert(id, 2, 1, 5, 273, 1076);
                seg.Insert(id, 2, 2, 10, 76, 487);
                seg.Insert(id, 3, 0, 15, 174, 778);
                seg.Insert(id, 3, 1, 5, 273, 1092);
                seg.Insert(id, 3, 2, 10, 76, 495);
                seg.Insert(id, 4, 0, 15, 174, 778);
                seg.Insert(id, 4, 1, 5, 273, 1092);
                seg.Insert(id, 4, 2, 10, 76, 487);
                seg.Insert(id, 5, 0, 15, 174, 778);
                seg.Insert(id, 5, 1, 5, 273, 1092);
                seg.Insert(id, 5, 2, 10, 76, 495);
                seg.Insert(id, 6, 0, 15, 174, 778);
                seg.Insert(id, 6, 1, 5, 273, 1107);
                ...
                seg.Insert(id, 10, 0, 15, 174, 778);
                seg.Insert(id, 10, 1, 5, 273, 1107);
                seg.Insert(id, 10, 2, 10, 76, 500);
                seg.Insert(id, 11, 0, 15, 174, 778);
                seg.Insert(id, 11, 1, 5, 273, 1080);
